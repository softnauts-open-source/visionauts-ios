...
@UIApplicationMain
class AppDelegate: UIResponder, UIApplicationDelegate, BluetoothServiceDelegate {
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        ...
        let context = CoreDataManager.shared.getContext(.main)
    ...
    func observeBluetoothState() {
        ServiceFactory.bluetoothService.delegate = self
    }
